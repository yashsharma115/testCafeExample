    ...
    ***************************************************************************** */
    ...
    var StatusBar = /** @class */ (function (_super) {
        ...
        StatusBar.prototype._createActionsArea = function () {
            ...
            shadowUI$3.addClass(this.actionsContainer, ACTIONS_CONTAINER_CLASS);
            this.statusBar.appendChild(this.actionsContainer);
            this.buttons = document.createElement('div');
            shadowUI$3.addClass(this.buttons, BUTTONS_CLASS);
            ...
            this._bindClickOnce([this.unlockButton], function () {
                shadowUI$3.removeClass(_this.unlockButton, LOCKED_BUTTON_CLASS);
                shadowUI$3.addClass(_this.unlockButton, UNLOCKED_BUTTON_CLASS);
                nativeMethods$a.nodeTextContentSetter.call(_this.unlockButton.querySelector('span'), PAGE_UNLOCKED_TEXT);
        ...
        StatusBar.prototype._create = function () {
            ...
            shadowUI$3.addClass(this.statusBar, STATUS_BAR_CLASS);
        ...
        StatusBar.prototype._createBeforeReady = function () {
            ...
            if (document.body)
                ...
                nativeMethods$a.setTimeout.call(window, function () { return _this._createBeforeReady(); }, 0);
        };
        StatusBar.prototype._animate = function (show) {
            var _this = this;
            var startTime = nativeMethods$a.dateNow();
            var startOpacityValue = parseInt(styleUtils$3.get(this.statusBar, 'opacity'), 10) || 0;
            var passedTime = 0;
            var progress = 0;
            var delta = 0;
            this._stopAnimation();
            if (show) {
                styleUtils$3.set(this.statusBar, 'visibility', '');
                this.state.hidden = false;
            }
            this.animationInterval = nativeMethods$a.setInterval.call(window, function () {
                passedTime = nativeMethods$a.dateNow() - startTime;
                progress = Math.min(passedTime / ANIMATION_DELAY, 1);
                delta = 0.5 - Math.cos(progress * Math.PI) / 2;
                styleUtils$3.set(_this.statusBar, 'opacity', startOpacityValue + (show ? delta : -delta));
                if (progress === 1) {
                    _this._stopAnimation();
                    if (!show) {
                        styleUtils$3.set(_this.statusBar, 'visibility', 'hidden');
        ...
        StatusBar.prototype._stopAnimation = function () {
            if (this.animationInterval) {
                nativeMethods$a.clearInterval.call(window, this.animationInterval);
                this.animationInterval = null;
            }
        };
        ...
        StatusBar.prototype._bindHandlers = function () {
            var _this = this;
            listeners$2.initElementListening(window, ['resize']);
            listeners$2.addInternalEventBeforeListener(window, ['resize'], function () {
                _this.windowHeight = window.innerHeight;
            });
            listeners$2.addFirstInternalEventBeforeListener(window, ['mousemove', 'mouseout', 'touchmove'], function (e) {
        ...
        StatusBar.prototype._bindClickOnce = function (elements, handler) {
            ...
            var downHandler = function (e) {
                var target = nativeMethods$a.eventTargetGetter.call(e);
                var isTargetElement = !!arrayUtils$8.find(elements, function (el) { return domUtils$a.containsElement(el, target); });
                if (isTargetElement) {
                    eventUtils$4.preventDefault(e);
                    listeners$2.removeInternalEventBeforeListener(window, [eventName], downHandler);
                    handler(e);
                }
                else if (domUtils$a.containsElement(_this.statusBar, target))
                    eventUtils$4.preventDefault(e);
            };
            listeners$2.addInternalEventBeforeListener(window, [eventName], downHandler);
        };
            ...
            messageSandbox$3.on(messageSandbox$3.SERVICE_MSG_RECEIVED_EVENT, function (e) {
                ...
                if (msg.cmd === MESSAGES.startWaitingElement)
                    ...
                    _this.hideWaitingElementStatus(msg.waitingSuccess)
                        .then(function () { return messageSandbox$3.sendServiceMsg({ cmd: MESSAGES.endWaitingElementResponse }, e.source); });
                }
                    ...
                    _this.hideWaitingAssertionRetriesStatus(msg.waitingSuccess)
                        .then(function () { return messageSandbox$3.sendServiceMsg({ cmd: MESSAGES.endWaitingAssertionRetriesResponse }, e.source); });
                }
            });
        };
        StatusBar.prototype._resetState = function () {
            this.state.debugging = false;
            shadowUI$3.removeClass(uiRoot.panelsContainer(), STATUS_BAR_DEBUGGING_CLASS);
            this.actionsContainer.style.display = 'none';
            this.unlockButton.style.display = 'none';
            nativeMethods$a.nodeTextContentSetter.call(this.statusDiv, this._getFullStatusText(''));
        ...
        StatusBar.prototype._showWaitingStatus = function () {
            ...
            nativeMethods$a.nodeTextContentSetter.call(this.statusDiv, this._getFullStatusText(waitingStatusText));
            this.progressBar.show();
        };
        StatusBar.prototype._hideWaitingStatus = function (forceReset) {
            var _this = this;
            return new Promise$3(function (resolve) {
                nativeMethods$a.setTimeout.call(window, function () {
                    if (_this.state.waiting || _this.state.debugging) {
                        resolve();
                        return;
                    }
                    shadowUI$3.removeClass(_this.statusBar, WAITING_SUCCESS_CLASS);
                    shadowUI$3.removeClass(_this.statusBar, WAITING_FAILED_CLASS);
        ...
        StatusBar.prototype._showDebuggingStatus = function (isTestError) {
            ...
            return new Promise$3(function (resolve) {
                ...
                shadowUI$3.addClass(uiRoot.panelsContainer(), STATUS_BAR_DEBUGGING_CLASS);
                if (isTestError) {
                    ...
                    nativeMethods$a.nodeTextContentSetter.call(_this.statusDiv, _this._getFullStatusText(TEST_FAILED_TEXT));
                    shadowUI$3.removeClass(_this.statusBar, WAITING_SUCCESS_CLASS);
                    shadowUI$3.addClass(_this.statusBar, WAITING_FAILED_CLASS);
                }
                else
                    nativeMethods$a.nodeTextContentSetter.call(_this.statusDiv, _this._getFullStatusText(DEBUGGING_TEXT));
                ...
                _this._bindClickOnce([_this.resumeButton, _this.nextButton, _this.finishButton], function (e) {
                    var target = nativeMethods$a.eventTargetGetter.call(e);
                    var isNextButton = domUtils$a.containsElement(_this.nextButton, target);
                    _this._resetState();
        ...
        StatusBar.prototype._setWaitingStatus = function (timeout, startTime) {
            ...
            this.showingTimeout = nativeMethods$a.setTimeout.call(window, function () {
                _this.showingTimeout = null;
        ...
        StatusBar.prototype._resetWaitingStatus = function (waitingSuccess) {
            ...
            if (waitingSuccess)
                shadowUI$3.addClass(this.statusBar, WAITING_SUCCESS_CLASS);
            else
                shadowUI$3.addClass(this.statusBar, WAITING_FAILED_CLASS);
            var forceReset = this.showingTimeout && waitingSuccess;
            if (this.showingTimeout) {
                nativeMethods$a.clearTimeout.call(window, this.showingTimeout);
        ...
        StatusBar.prototype.showDebuggingStatus = function (isTestError) {
            this._stopAnimation();
            styleUtils$3.set(this.statusBar, 'opacity', 1);
            styleUtils$3.set(this.statusBar, 'visibility', '');
    ...
    var sendRequestToFrame$1 = testCafeCore__default["default"].sendRequestToFrame;
    ...
    var IframeStatusBar = /** @class */ (function (_super) {
        ...
        IframeStatusBar.prototype.showWaitingElementStatus = function (timeout) {
            messageSandbox$2.sendServiceMsg({ cmd: MESSAGES.startWaitingElement, timeout: timeout }, window.top);
        };
        IframeStatusBar.prototype.hideWaitingElementStatus = function (waitingSuccess) {
            ...
            return sendRequestToFrame$1(msg, MESSAGES.endWaitingElementResponse, window.top);
        };
        IframeStatusBar.prototype.showWaitingAssertionRetriesStatus = function (timeout) {
            messageSandbox$2.sendServiceMsg({ cmd: MESSAGES.startWaitingAssertionRetries, timeout: timeout }, window.top);
        };
        IframeStatusBar.prototype.hideWaitingAssertionRetriesStatus = function (waitingSuccess) {
            ...
            return sendRequestToFrame$1(msg, MESSAGES.endWaitingAssertionRetriesResponse, window.top);
        };
    ...
    var shadowUI$2 = hammerhead__default["default"].shadowUI;
        ...
        switch (msg.cmd) {
            case CURSOR_UI_MESSAGES.moveRequest:
                CursorUI.move(positionUtils.getIframePointRelativeToParentFrame({ x: msg.x, y: msg.y }, e.source))
                    .then(function () { return messageSandbox$1.sendServiceMsg({ cmd: CURSOR_UI_MESSAGES.moveResponse }, e.source); });
                break;
            case CURSOR_UI_MESSAGES.leftButtonDownRequest:
                CursorUI.leftButtonDown()
                    .then(function () { return messageSandbox$1.sendServiceMsg({ cmd: CURSOR_UI_MESSAGES.leftButtonDownResponse }, e.source); });
                break;
            case CURSOR_UI_MESSAGES.rightButtonDownRequest:
                CursorUI.rightButtonDown()
                    .then(function () { return messageSandbox$1.sendServiceMsg({ cmd: CURSOR_UI_MESSAGES.rightButtonDownResponse }, e.source); });
                break;
            case CURSOR_UI_MESSAGES.buttonUpRequest:
                CursorUI.buttonUp()
                    .then(function () { return messageSandbox$1.sendServiceMsg({ cmd: CURSOR_UI_MESSAGES.buttonUpResponse }, e.source); });
                break;
        }
    });
    var CursorUI = {
        ...
        _createElement: function () {
            ...
            shadowUI$2.addClass(this.cursorElement, CURSOR_CLASS);
            if (featureDetection.isTouchDevice) {
                shadowUI$2.addClass(this.cursorElement, TOUCH_CLASS);
                // NOTE: in touch mode, the pointer should be in the center of the cursor
                this.pointerOffsetX = Math.ceil(styleUtils$2.getWidth(this.cursorElement) / 2);
                this.pointerOffsetY = Math.ceil(styleUtils$2.getHeight(this.cursorElement) / 2);
            }
        ...
        isVisible: function () {
            return this.cursorElement && styleUtils$2.get(this.cursorElement, 'visibility') !== 'hidden';
        },
        hide: function () {
            if (!this._ensureCursorElement())
                return;
            if (this.isVisible())
                styleUtils$2.set(this.cursorElement, 'visibility', 'hidden');
        },
        show: function () {
            if (!this._ensureCursorElement())
                return;
            styleUtils$2.set(this.cursorElement, 'visibility', '');
        },
        move: function (position) {
            if (this._ensureCursorElement()) {
                this.x = position.x;
                this.y = position.y;
                styleUtils$2.set(this.cursorElement, {
        ...
        leftButtonDown: function () {
            if (this._ensureCursorElement()) {
                shadowUI$2.removeClass(this.cursorElement, STATE_CLASSES);
                shadowUI$2.addClass(this.cursorElement, L_MOUSE_DOWN_CLASS);
            }
            return Promise$2.resolve();
        },
        rightButtonDown: function () {
            if (this._ensureCursorElement()) {
                shadowUI$2.removeClass(this.cursorElement, STATE_CLASSES);
                shadowUI$2.addClass(this.cursorElement, R_MOUSE_DOWN_CLASS);
            }
            return Promise$2.resolve();
        },
        buttonUp: function () {
    ...
    var shadowUI$1 = hammerhead__default["default"].shadowUI;
    ...
    function createElementFromDescriptor(descriptor) {
        ...
        if (type)
            nativeMethods$9.setAttribute.call(element, 'type', type);
        if (value)
            nativeMethods$9.inputValueSetter.call(element, value);
        if (src)
            nativeMethods$9.setAttribute.call(element, 'src', src);
        if (className)
            shadowUI$1.addClass(element, className);
        if (text)
            nativeMethods$9.nodeTextContentSetter.call(element, text);
        return element;
    }
    ...
    function setStyles(element, styles) {
        for (var key in styles)
            styleUtils$1.set(element, key, styles[key]);
    }
    ...
    var domUtils$9 = TESTCAFE_CORE.domUtils, arrayUtils$7 = TESTCAFE_CORE.arrayUtils;
    function getNthFilterOptions(el, parent) {
        var index = domUtils$9.getElementIndexInParent(parent, el);
        var tagFilterOption = new FilterOption(byTag, domUtils$9.getTagName(el));
        if (index === 0)
    ...
    function getTagTreeFilterOptions(element, parents) {
        var filterOptions = arrayUtils$7.reverse(getNthFilterOptions(element, parents[0]));
        ...
        return arrayUtils$7.reverse(filterOptions);
    }
    function isHtmlOrBodyElement(element) {
        return /html|body/.test(domUtils$9.getTagName(element).toLowerCase());
    }

    var domUtils$8 = TESTCAFE_CORE.domUtils, arrayUtils$6 = TESTCAFE_CORE.arrayUtils;
    function optionsToStringArray(options) {
        var strings = [];
        for (var _i = 0, options_1 = options; _i < options_1.length; _i++) {
            var option = options_1[_i];
            if (arrayUtils$6.indexOf(options, option) === 0)
    ...
    var SelectorDescriptor = /** @class */ (function () {
        function SelectorDescriptor(obj) {
            ...
            this.filterOptions = arrayUtils$6.concat([], obj.filterOptions || []);
        ...
        SelectorDescriptor.prototype._addFilterByIndex = function (elements) {
            if (elements.length > 1) {
                var elementIndex = arrayUtils$6.indexOf(elements, this.element);
                if (elementIndex !== 0)
        ...
        SelectorDescriptor.prototype._concatFilterOptions = function () {
            ...
            var concatenatedOpts = arrayUtils$6.concat(initialOptions, this.filterOptions);
            return arrayUtils$6.reduce(concatenatedOpts, function (options, option) {
        ...
        SelectorDescriptor.prototype._getElements = function () {
            ...
            if (this.ruleType === RULE_TYPE.byTagTree)
                return [this.element];
            var ancestor = this.ancestorSelectorDescriptor ? this.ancestorSelectorDescriptor.element : domUtils$8.findDocument(this.element);
            var elements = null;
            if (this.cssSelector) {
                ...
                try {
                    ...
                    elements = arrayUtils$6.from(ancestor.querySelectorAll(evaluatedString));
                }
                catch (err) {
                    return null;
                }
            ...
            if (elements.length === 0 || arrayUtils$6.indexOf(elements, this.element) === -1)
                return [];
            return elements;
        };
    ...
    var TagNameSelectorCreator = /** @class */ (function (_super) {
        ...
        TagNameSelectorCreator.prototype._init = function () {
            this.tagName = domUtils$7.getTagName(this.element);
        };
    ...
    function escapeRe(str) {
        return str.replace(SYMBOLS_TO_ESCAPE_RE$1, '\\$&');
    }

    var selectorAttributeFilter = TESTCAFE_CORE.selectorAttributeFilter, arrayUtils$5 = TESTCAFE_CORE.arrayUtils;
    ...
    function getTextFilter(text) {
        return function (elements) {
            return arrayUtils$5.filter(elements, function (el) {
                var elementText = nativeMethods$8.htmlElementInnerTextGetter.call(el) ||
                    nativeMethods$8.nodeTextContentGetter.call(el);
    ...
    function getAttributeRegExpFilter(_a) {
        ...
        return function (elements) {
            return arrayUtils$5.filter(elements, function (el) { return selectorAttributeFilter(el, 0, void 0, makeRegExp(attrName), makeRegExp(attrValueRe)); });
        };
    }

    var domUtils$6 = TESTCAFE_CORE.domUtils, arrayUtils$4 = TESTCAFE_CORE.arrayUtils;
    ...
    function getAttributesDescriptor(ruleType, el, attributes, ancestorSelectorDescriptor) {
        var tagName = domUtils$6.getTagName(el);
        var cssSelector = '';
        var attrRegExpObject = null;
        arrayUtils$4.forEach(attributes, function (_a) {
            var name = _a.name, value = _a.value;
            var valueWasCut = false;
            var shouldUseRegExp = false;
            if (value.replace(SOME_SPACES_RE, ' ').length > MAX_TEXT_LENGTH_IN_SELECTOR$1) {
                value = value.substr(0, MAX_TEXT_LENGTH_IN_SELECTOR$1);
                valueWasCut = true;
            }
    ...
    var domUtils$5 = TESTCAFE_CORE.domUtils;
    ...
    var IdSelectorCreator = /** @class */ (function (_super) {
        ...
        IdSelectorCreator.prototype._getDescriptor = function () {
            if (ASP_AUTOGENERATED_ID_PART_RE.test(this.idAttr)) {
                ...
                var tagName = domUtils$5.getTagName(this.element);
    ...
    function hasOwnTextForSelector(el, elementText) {
        if (!ELEMENTS_WITH_TEXT_RE.test(domUtils$4.getTagName(el)))
            return '';
    ...
    function getOwnTextForSelector(el) {
        /*eslint-disable-next-line no-restricted-properties*/
        var text = domUtils$4.isHtmlElement(el) ? nativeMethods$7.htmlElementInnerTextGetter.call(el) : el.innerText;
        if (text)
            return getTextPart(text);
        if (domUtils$4.isOptionElement(el)) {
    ...
    var domUtils$3 = TESTCAFE_CORE.domUtils;
    var TextSelectorCreator = /** @class */ (function (_super) {
        ...
        TextSelectorCreator.prototype._getDescriptor = function () {
            return new SelectorDescriptor({
                ruleType: this.type,
                element: this.element,
                cssSelector: domUtils$3.getTagName(this.element),
    ...
    var domUtils$2 = TESTCAFE_CORE.domUtils, arrayUtils$3 = TESTCAFE_CORE.arrayUtils;
    ...
    function isAttributeAcceptableForSelector(attribute, customAttrNames) {
        ...
        return ALLOWED_ATTRIBUTE_NAMES_RE.test(name) &&
            arrayUtils$3.indexOf(customAttrNames, name) === -1 &&
            !GOOGLE_ANALYTICS_ATTRIBUTE_RE.test(name) &&
            !domUtils$2.isHammerheadAttr(name);
    }
    function getAttributesForSelector(element, customAttrNames) {
        ...
        if (storedAttributes)
            return arrayUtils$3.filter(storedAttributes, function (attr) { return attr.name !== CLASS_ATTRIBUTE_NAME; });
        var attributes = nativeMethods$6.elementAttributesGetter.call(element);
    ...
    function getAttributeValue(element, attrName) {
        var attributes = element[STORED_ATTRIBUTES_PROPERTY] || nativeMethods$6.elementAttributesGetter.call(element);
        var attribute = null;
        for (var i = 0; i < attributes.length; i++) {
            attribute = attributes[i];
            /*eslint-disable no-restricted-properties*/
    ...
    function getCustomAttributeForSelector(el, customAttrName) {
        ...
        if (customStoredAttributes) {
            var storedAttr = arrayUtils$3.find(customStoredAttributes, function (attr) { return attr.name === customAttrName; });
    ...
    var domUtils$1 = TESTCAFE_CORE.domUtils, arrayUtils$2 = TESTCAFE_CORE.arrayUtils;
    var TagTreeSelectorCreator = /** @class */ (function (_super) {
        ...
        TagTreeSelectorCreator.prototype._shouldCreate = function (ancestorSelectorDescriptor) {
            var ancestor = ancestorSelectorDescriptor ?
                ancestorSelectorDescriptor.element : domUtils$1.findDocument(this.element).body;
        ...
        TagTreeSelectorCreator.prototype._getDescriptor = function (ancestorSelectorDescriptor) {
            ...
            if (isHtmlOrBodyElement(this.element))
                filterOptions.push(new FilterOption(byTag, domUtils$1.getTagName(this.element)));
            else
            ...
            if (filterOptions.length) {
                ...
                arrayUtils$2.splice(filterOptions, 0, 1);
            }
            return new SelectorDescriptor({
                ruleType: this.type,
                element: this.element,
    ...
    var _a$1;
    var SELECTOR_CREATORS = (_a$1 = {},
        _a$1[RULE_TYPE.byTagName] = new TagNameSelectorCreator(),
        _a$1[RULE_TYPE.byId] = new IdSelectorCreator(),
        _a$1[RULE_TYPE.byText] = new TextSelectorCreator(),
        _a$1[RULE_TYPE.byClassAttr] = new ClassSelectorCreator(),
        _a$1[RULE_TYPE.byAttr] = new AttrSelectorCreator(),
        _a$1[RULE_TYPE.byTagTree] = new TagTreeSelectorCreator(),
        _a$1);
    ...
    var arrayUtils$1 = TESTCAFE_CORE.arrayUtils;
    ...
    function isSelectorDescriptorCompoundable(selectorDescriptor) {
        return selectorDescriptor.isCustomRule ||
            arrayUtils$1.indexOf(COMPOUNDABLE_CHILD_RULE_TYPES, selectorDescriptor.ruleType) !== -1 &&
                selectorDescriptor.ruleType !== RULE_TYPE.byTagTree;
    }
    function isChildRuleCompoundable(rule) {
        return rule.editable || arrayUtils$1.indexOf(COMPOUNDABLE_CHILD_RULE_TYPES, rule.type) !== -1;
    }
    function isAncestorRuleCompoundable(rule) {
        return rule.editable || arrayUtils$1.indexOf(COMPOUNDABLE_ANCESTOR_RULE_TYPES, rule.type) !== -1;
    }
    ...
    var domUtils = TESTCAFE_CORE.domUtils, arrayUtils = TESTCAFE_CORE.arrayUtils;
    ...
    function removeRedundantCompoundSelectorDescriptors(selectorDescriptors) {
        var defaultRuleSelectors = arrayUtils.filter(selectorDescriptors, function (descriptor) { return !descriptor.isCustom; });
        var defaultCompoundRuleSelectors = arrayUtils.filter(defaultRuleSelectors, function (descriptor) { return descriptor.ancestorSelectorDescriptor; });
    ...
    var SelectorGenerator = /** @class */ (function () {
        function SelectorGenerator(rules) {
            ...
            this.rules = arrayUtils.filter(rules, function (rule) { return !rule.disabled; });
        ...
        SelectorGenerator._processRules = function (rules) {
            var defaultRules = [];
            var customRules = [];
            arrayUtils.filter(rules, function (rule) {
                if (rule.editable)
        ...
        SelectorGenerator.prototype._createCustomSelectorCreators = function () {
            var _this = this;
            arrayUtils.forEach(this.customRules, function (rule) {
        ...
        SelectorGenerator.prototype._createElementSelectorCreators = function () {
            var _this = this;
            var defaultCreators = [];
            arrayUtils.forEach(this.defaultRules, function (rule) {
        ...
        SelectorGenerator.prototype._generateCompoundSelectorDescriptor = function (el, ancestors, elementSelectorDescriptors) {
            var compoundSelectorDescriptors = arrayUtils.filter(elementSelectorDescriptors, isSelectorDescriptorCompoundable);
        ...
        SelectorGenerator.prototype._generateDescriptors = function (el) {
            ...
            var ancestors = getParentsUntil(el, domUtils.findDocument(el).body);
            var compoundSelectorDescriptors = this._generateCompoundSelectorDescriptor(el, ancestors, elementSelectorDescriptors);
            var selectorDescriptors = arrayUtils.concat(elementSelectorDescriptors, compoundSelectorDescriptors);
        ...
        SelectorGenerator.prototype.generate = function (element) {
            ...
            return arrayUtils.map(selectorDescriptors, function (selectorDescriptor) {
    ...
    var Tooltip = /** @class */ (function () {
        ...
        Tooltip.prototype._createElements = function () {
            this.tooltip = createElementFromDescriptor(tooltip$1);
            this.arrow = createElementFromDescriptor(arrow);
        };
        Tooltip.prototype._setTooltipText = function (selector) {
            nativeMethods$5.nodeTextContentSetter.call(this.tooltip, selector);
        };
    ...
    var serviceUtils$1 = testCafeCore__default["default"].serviceUtils;
    ...
    var ElementPicker = /** @class */ (function (_super) {
        ...
        ElementPicker.prototype._hideTestCafeElements = function () {
            ...
            for (var _i = 0, children_1 = children; _i < children_1.length; _i++) {
                ...
                var visibilityValue = styleUtils.get(element, 'visibility');
        ...
        ElementPicker.prototype._getClickHandler = function () {
            ...
            return function () {
                ...
                listeners$1.removeInternalEventBeforeListener(window, ['mousemove'], _this.handlers.onMouseMove);
                listeners$1.removeInternalEventBeforeListener(window, ['click'], _this.handlers.onClick);
        ...
        ElementPicker.prototype._getMouseMoveHandler = function () {
            ...
            return function (event) {
                ...
                // eslint-disable-next-line no-restricted-properties
                tooltip.show(_this.actualSelectors[0].value, target);
            };
        };
        ElementPicker.prototype.start = function (startEvent) {
            this._hideTestCafeElements();
            listeners$1.initElementListening(window, ['mousemove', 'click']);
            listeners$1.addFirstInternalEventBeforeListener(window, ['mousemove'], this.handlers.onMouseMove);
            listeners$1.addFirstInternalEventBeforeListener(window, ['click'], this.handlers.onClick);
    ...
    function castArray(elements) {
        return nativeMethods$4.isArray(elements) ? elements : [elements];
    }

    var listeners = hammerhead__default["default"].eventSandbox.listeners;
    var serviceUtils = testCafeCore__default["default"].serviceUtils;
    ...
    var SelectorsList = /** @class */ (function (_super) {
        ...
        function SelectorsList() {
            ...
            _this.element = createElementFromDescriptor(selectorsList$1);
    ...
    var selectorsList = new SelectorsList();
    ...
    var SelectorInputContainer = /** @class */ (function () {
        ...
        Object.defineProperty(SelectorInputContainer.prototype, "value", {
            get: function () {
                return nativeMethods$3.inputValueGetter.call(this.input);
            },
            set: function (value) {
                nativeMethods$3.inputValueSetter.call(this.input, value);
            },
            enumerable: false,
            configurable: true
        });
        ...
        SelectorInputContainer.prototype._addEventListeners = function () {
            var _this = this;
            eventUtils$2.bind(this.expandButton, 'click', function () { return _this._expandSelectorsList(); });
            eventUtils$2.bind(this.input, 'input', function () { return _this._onSelectorTyped(); });
            eventUtils$2.bind(this.input, 'focus', function () { return _this._onFocusInput(); });
            eventUtils$2.bind(this.input, 'blur', function () { return highlighter.stopHighlighting(); });
            selectorsList.on(LIST_CHANGED, function (selectors) {
                _this._updateExpandButton(selectors);
            });
            selectorsList.on(SELECTOR_SELECTED, function (value) {
        ...
        SelectorInputContainer.prototype._setMatchIndicatorText = function (text) {
            nativeMethods$3.nodeTextContentSetter.call(this.indicator, text);
        };
    ...
    var eventUtils$1 = testCafeCore__default["default"].eventUtils;
    ...
    var CopyButton = /** @class */ (function () {
        function CopyButton(sourceElement) {
            ...
            eventUtils$1.bind(this.element, 'click', function () { return _this._copySelector(); });
        }
        ...
        CopyButton.prototype._animate = function () {
            ...
            nativeMethods$2.setTimeout.call(window, function () { return _this._resetAppearance(); }, ANIMATION_TIMEOUT);
        };
        ...
        CopyButton.prototype._changeAppearance = function (value, fontWeight) {
            nativeMethods$2.inputValueSetter.call(this.element, value);
    ...
    var HideButton = /** @class */ (function () {
        function HideButton(selectorInspectorPanel) {
            ...
            eventUtils.bind(this.element, 'click', function () { return _this._showAndHide(selectorInspectorPanel); });
        }
        HideButton.prototype._showAndHide = function (selectorInspectorPanel) {
            nativeMethods$1.elementClassListGetter.call(selectorInspectorPanel).toggle(SELECTOR_INSPECTOR_PANEL_HIDDEN_CLASSNAME);
        };
        return HideButton;
    }());
    ...
    var sendRequestToFrame = testCafeCore__default["default"].sendRequestToFrame;
    ...
    nativeMethods.objectDefineProperty(window, '%testCafeUI%', { configurable: true, value: exports$1 });
    // eslint-disable-next-line no-undef
    hammerhead__default["default"].on(evalIframeScript, function (e) { return initTestCafeUI(nativeMethods.contentWindowGetter.call(e.iframe), true); });
